 ...
 %File creation date: 11/29/20  at 18:18
...
\psset{linecolor=black,tnsep=1pt,tndepth=0cm,tnheight=0cm,treesep=2.0cm,levelsep=55pt,radius=10pt}
    \Tcircle[fillcolor=purple,fillstyle=solid]{ 1 }~{\shortstack[c]{\emph{2253}\\ 0.18}}
 \end{center}
...
for predicting \texttt{\detokenize{USAScore}}.
 ...
 Best split variable is \texttt{\detokenize{UKScore}}.
 %\end{landscape}
 \end{document}
